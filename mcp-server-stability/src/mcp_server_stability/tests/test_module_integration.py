...
class TestStabilityServiceIntegration:
    ...
    @pytest.mark.asyncio
    async def test_full_service_lifecycle(self, mock_stability_config, sample_generation_params, mock_successful_response):
    ...
    @pytest.mark.asyncio
    async def test_service_factory_and_usage(self, sample_generation_params, mock_successful_response):
        mock_config = Mock()
        ...
        with patch('mcp_server_stability.stable_diffusion.module.StableDiffusionClientConfig') as mock_config_class:
    ...
    @pytest.mark.asyncio
    async def test_error_recovery_scenario(self, mock_stability_config, sample_generation_params):
        service = self.StabilityService(mock_stability_config)
    ...
    @pytest.mark.asyncio
    async def test_multiple_services_isolation(self, sample_generation_params, mock_successful_response):
        config1 = Mock()
    ...
    @pytest.mark.asyncio
    async def test_concurrent_service_operations(self, mock_stability_config, mock_successful_response):
        service = self.StabilityService(mock_stability_config)
...
class TestStabilityServiceWorkflowIntegration:
    ...
    @pytest.mark.asyncio
    async def test_request_retry_workflow(self, mock_stability_config, sample_generation_params):
        service = self.StabilityService(mock_stability_config)
    ...
    @pytest.mark.asyncio
    async def test_batch_processing_workflow(self, mock_stability_config, mock_successful_response):
        service = self.StabilityService(mock_stability_config)
    ...
    @pytest.mark.asyncio
    async def test_configuration_change_workflow(self, sample_generation_params, mock_successful_response):
        config1 = Mock()

...
class TestAaveClient:
    ...
    def test_cache_key_generation(self, mock_aave_config):
        ...
        key = client._get_cache_key(
            "get_asset_risk_data", asset_address="0x123", network="polygon"
        )
    ...
    @pytest.mark.asyncio
    async def test_get_markets_data_success(
        self, mock_aave_config, sample_aave_api_response
    ):
        ...
        with aioresponses() as mocked:
            ...
            mocked.post(
                mock_aave_config.api_base_url,
                status=200,
                payload=sample_aave_api_response,
            )
    ...
    @pytest.mark.asyncio
    async def test_get_markets_data_from_cache(
        self, mock_aave_config, sample_pool_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_pool_data_with_different_network(
        self, mock_aave_config, sample_aave_api_response
    ):

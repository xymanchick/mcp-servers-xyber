...
class AssetData(BaseModel):
    ...
    def from_reserve_data(cls, reserve: ReserveData, market_data: Dict[str, Any]) -> AssetData:
        ...
        return cls(
            ...
            total_borrow=reserve.borrow_info.total if reserve.borrow_info else Decimal("0"),
            utilization_rate=Decimal(reserve.borrow_info.utilization_rate) if reserve.borrow_info else Decimal("0"),

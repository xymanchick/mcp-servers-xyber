...
def require_base_url(config: E2ETestConfig) -> None:
    if not config.base_url:
        ...
        pytest.skip("Set MCP_QUILL_E2E_BASE_URL to run E2E tests.")
...
def require_wallet(config: E2ETestConfig) -> None:
    if not config.private_key:
        ...
        pytest.skip("Set MCP_QUILL_TEST_PRIVATE_KEY to run x402 payment E2E tests.")


def require_quill_api_key(config: E2ETestConfig) -> str:

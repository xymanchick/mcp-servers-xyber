...
class X402Config(BaseSettings):
    ...
    model_config = SettingsConfigDict(
        env_prefix="MCP_TOGETHER_IMGEN_X402_",
        env_file=".env",
    ...
    def validate_pricing_mode(self) -> None:
        ...
        if self.pricing_mode == "on" and not has_pricing:
            raise ValueError(
                ...
                "Either set MCP_TOGETHER_IMGEN_X402_PRICING_MODE=off or provide a valid "
        ...
        if self.pricing_mode == "off" and has_pricing:
            logger.warning(
                ...
                "Set MCP_TOGETHER_IMGEN_X402_PRICING_MODE=on to enable payments."
            )

...
class TestSearchEndpoint:
    ...
    def test_search_endpoint_success(
        ...
        try:
            response = client.get("/hybrid/search?q=test&limit=10&page=0")
    ...
    def test_search_endpoint_empty_results(self, app: FastAPI, mock_lurky_client: Mock):
        ...
        client = TestClient(app)
        try:
            response = client.get("/hybrid/search?q=nonexistent&limit=10&page=0")
...
class TestGetSpaceDetailsEndpoint:
    ...
    def test_get_space_details_success(
        ...
        mock_lurky_client.get_space_details = AsyncMock(
            return_value=sample_space_details
        )
    ...
    def test_get_space_details_not_found(self, app: FastAPI, mock_lurky_client: Mock):
        ...
        mock_lurky_client.get_space_details = AsyncMock(
            side_effect=LurkyNotFoundError("Space not found")
        )
...
class TestLatestSummariesEndpoint:
    ...
    def test_latest_summaries_success(
        ...
        app: FastAPI,
        mock_lurky_client: Mock,
        sample_space_details: SpaceDetails,
        sample_search_response: SearchResponse,
    ):

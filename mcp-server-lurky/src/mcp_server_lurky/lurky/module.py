...
from mcp_server_lurky.lurky.errors import LurkyAPIError, LurkyAuthError, LurkyNotFoundError
        ...
        async with httpx.AsyncClient(timeout=self.config.timeout_seconds) as client:
            try:
                ...
                if response.status_code == 401:
                    ...
                    raise LurkyNotFoundError(f"Resource not found: {url}", status_code=404)

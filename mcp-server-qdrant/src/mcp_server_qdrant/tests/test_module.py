...
class TestFixtureIntegration:    
    ...
    def test_multilingual_entries_fixture(self, multilingual_entries):
        ...
        assert any("Привет" in content for content in contents)
        assert any("Hola" in content for content in contents)
        assert any("こんにちは" in content for content in contents)
        
        assert all("🌍" in entry.content for entry in multilingual_entries)

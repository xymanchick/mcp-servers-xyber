"""
Main application factory for the Qdrant MCP server.
...
from mcp_server_qdrant.mcp_routers import routers as mcp_routers
...
def create_app() -> FastAPI:
    ...
    mcp_server = FastMCP.from_fastapi(app=mcp_source_app, name="qdrant")

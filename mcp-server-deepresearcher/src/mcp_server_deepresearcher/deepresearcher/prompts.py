...
<GOAL>
Generate a structured final research report based on the provided summary.
</GOAL>
...
- "key_findings": An array of strings, each a detailed, unique bullet point or short paragraph (ensure non-repetitive content).
...
- Base it strictly on the provided summary, synthesizing information coherently.

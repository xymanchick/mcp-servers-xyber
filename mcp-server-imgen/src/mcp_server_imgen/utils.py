...
import logging
from mcp_server_imgen.google_client import _GoogleService, GoogleServiceError
...
@lru_cache(maxsize=1)
def get_image_generation_service(google_service: _GoogleService) -> _ImageGenerationService:
